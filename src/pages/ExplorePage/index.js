      ...
      <Sticky>
        <div className="w-full bg-primary p-4 lg:p-8 flex justify-between">
          <div className="flex items-center">
            <img className="w-5 h-5 cursor-pointer" src={Images.ArrowLeftIcon} alt="arrow-left" />
            <div className="px-6">
              <img
                className="w-14 h-14 p-3 manta-bg-secondary rounded-full"
                src={Images.TokenIcon}
                alt="p"
              />
            </div>
            <span className="text-2xl font-semibold text-thirdry">Polkadot</span>
          </div>
