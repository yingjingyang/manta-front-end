...
const SidebarMenu = () => {
  ...
  return (
    <div className="menu-content lg:py-4">
      ...
      <NavLink className="text-secondary block pl-4 pr-7" activeClassName="text-primary active bg-button" to="/pool">
        <div className="py-2 w-full group menu-content__item flex items-center">
          <div className="p-3">
            <svg
              width="26"
      ...
      <NavLink className="text-secondary block pl-4 pr-7" activeClassName="text-primary active bg-button" to="/govern">
        <div className="py-2 w-full group menu-content__item flex items-center">
          <div className="p-3">
            <svg
              width="30"
      ...
      <NavLink className="text-secondary block pl-4 pr-7" activeClassName="text-primary active bg-button" to="/audit">
        <div className="py-2 w-full group menu-content__item flex items-center">
          <div className="p-3">
            <svg
              width="24"
      ...
      <NavLink className="text-secondary block pl-4 pr-7" activeClassName="text-primary active bg-button" to="/explore">
        <div className="py-2 w-full group menu-content__item flex items-center">
          <div className="p-3">
            <svg
              width="28"
