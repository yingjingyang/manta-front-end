...
const AccountSelect = () => {
  ...
  const handleOnClick = () => {
    ...
    !!web3ExtensionInjected || showModal();
  };
  ...
  console.log(`
  ------------
  externalAccount - ${externalAccount?.address}
  externalAccountOptions - ${externalAccountOptions[0]?.address}
  ------------
  `);
  const accountBox = (
  ...
  return externalAccount ? accountBox : connectAccountBox;
};
