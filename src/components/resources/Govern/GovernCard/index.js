...
const GovernCard = ({ className }) => {
  return (
    <div
      className={classNames('govern-card p-6 bg-thirdry rounded-lg frame-box-shadow', className)}
    >
      <div className="flex flex-col xl:flex-row justify-between">
        ...
        <div className="flex items-center pb-2">
          <img src={Images.ClockIcon} className="pr-2" alt="clock-time" />
      ...
      <div className="flex flex-col xl:flex-row xl:items-center">
        <div className="w-full pb-4 xl:pb-0 xl:w-3/4">
          <span className="manta-dark-gray text-sm">
            ...
            exercitation ullamco laboris nisi ut.Lorem ipsum dolor sit amet, consectetur adipiscing
            elit.
          </span>
        </div>
        <div className="w-full md:w-1/2 xl:w-1/4 flex xl:justify-end">
          <Button className="btn-primary w-full sm:w-auto py-3">Read More and Vote</Button>
        </div>
      </div>
    </div>
  );
