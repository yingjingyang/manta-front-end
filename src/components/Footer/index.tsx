...
const CalamariFooter = () => {
  return (
    <div className="mt-16 flex justify-between gap-20 bg-primary py-10 px-28">
      <div>
        <div className="text-2xl text-fourth">
          Calamari Network
        </div>
        ...
        <div className="flex items-center text-xl text-secondary">
          ...
          <span>by </span>
          <span
            className="cursor-pointer text-fourth duration-200 hover:text-secondary dark:hover:text-secondary"
      ...
      <div className="flex items-center gap-3">
        ...
        >
          <FontAwesomeIcon
            icon={faTwitter}
            className="w-6 duration-200 transform hover:scale-125 text-fourth text-xl"
          />
        </div>
        <div
          className="flex h-10 w-10 cursor-pointer items-center justify-center rounded-lg bg-secondary"
